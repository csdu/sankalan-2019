...
return [
    ...
    "code-auction" => [
        "isover" => false,
        "teamSize" => 4,
        "description" => "Think you got the knack for bidding? Trust your instincts and play with our money to earn money for you!\nSankalan is back and this time with a brand new challenge, Code Auction.",
        "title" => "Code Auction",
    ...
    "alacrity" => [
        ...
        "description" => "A Photography Competition is a platform to showcase your talent. While clicking away just for the sake of photography is a lot of fun, sometimes a competition can help you raise the bar as a photographer.",
        "title" => "Alacrity",
    ...
    "mind-matters" => [
        "isover" => false,
        "isnontech" => false,
        "description" => "Think you\u2019re Mr. Know-it-All of the silicon world? Come and participate in this event, test your knowledge, let the world know that and walk away as a champion.",
        "title" => "Mind Matters",
    ...
    "quriosity" => [
        "isover" => true,
        "description" => "Getting tired of lazily browsing through same old sitcoms wile waiting for dinner? Fret Not, for Sankalan 2019 presents Quriosity\u201918, every night at 10. From the 1st to the 28th of Feb, we will give you a knowledgeable prime-time. One that you are bound not to miss!",
        "title" => "Quriosity",
    ...
    "brainspark" => [
        "isover" => false,
        "isnontech" => false,
        "description" => "We'll judge your logical and quantitative abilities.\nAnd then we give you freaking cool puzzles to solve!",
        "title" => "BrainSpark",
        "quote" => [
    ...
    "coding-cup" => [
        "isover" => false,
        "isnontech" => false,
        "description" => "This is a special event mainly targeting the students of undergraduate pursuing their bachelor\u2019s in Computer Science from Delhi University.\nStudents will gain ample amount of knowledge and practice which will help them increase their coding skills.",
    ...
    "codeathon" => [
        "isover" => false,
        "isnontech" => false,
        "description" => "Do you have what it takes to survive a coding marathon? Then we have just the right thing for you...\nMultiple-choice questions based on concepts of C, C++ and Java.\n...then solve some real problems using C/C++/Java.",
        "title" => "Code-a-thon",
    ...
    "select-star-from-brain" => [
        "isover" => false,
        "isnontech" => false,
        "description" => "Multiple-choice questions based on standard SQL, XQuery and DBMS concepts.\n...then solve queries using SQL.",
    ...
    "algoholics" => [
        "isover" => false,
        "isnontech" => false,
        "description" => "Multiple-choice based questions testing the participant\u2019s algorithmic competency.\n...then solve set of problems overnight to develop algorithms.",
        "title" => "Algoholics",
        "quote" => [
